...
public:
    ...
    QVector<QTouchEvent *> cachedTouch;
    bool flushTouch : 1;

    void * jhelper;
    void * (*startJingosHelper)(void);
    void (*stopJingosHelper)(void *);
    bool (*frameSynchronousEvents)(void *);
    QTouchEvent * (*takeTouchEventFromCache)(void *);
    bool (*jCompressTouchEvent)(void *,QTouchEvent *);
    bool (*mergeTouchEvent)(void *,QTouchEvent *);
    void (*pushTouchEventToCache)(void *,QTouchEvent *);
    bool (*isCacheTouchEmpty)(void *);
